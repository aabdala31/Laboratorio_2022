...
public class Grupo_sensores {
    ...
    public void agregarSensores(Detector_Humo detector_humo, Sensor_Presion sensor_presion, Sensor_Temperatura sensor_temperatura){
        this.detectores_humo.add(detector_humo);
        this.sensores_presion.add(sensor_presion);
        this.sensores_temperatura.add(sensor_temperatura);
    }
    public int cantidadSensores(){
        return (detectores_humo.size() - 1) + (sensores_presion.size() - 1) + (sensores_temperatura.size() - 1);
    }
